...
namespace Data.Migrations
{
    ...
    [Migration("20250316004005_EditAuthorizeSession2")]
    partial class EditAuthorizeSession2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.AuthorizationSession", b =>
                {
                    ...
                    b.Property<string>("ModelGatewatId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entities.UserModelAi", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Entities.AuthorizationSession", b =>
                {
                    b.HasOne("Entities.ModelGateway", "ModelGateway")
                        .WithMany()
